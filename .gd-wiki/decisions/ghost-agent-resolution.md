...
> Update 2026-06-12: when effort enforcement was added, `gd-project-manager` moved to the `light` tier (Sonnet, low effort) and `gd-debugger` to the `deep` tier (Opus, xhigh effort) — see [[model-tier-policy]].
