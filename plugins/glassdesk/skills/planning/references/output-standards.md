...
Each phase file contains sections (in order): Context links, Overview, Key Insights, Requirements, Architecture, Related code files, Implementation Steps, Todo list, Success Criteria, Risk Assessment, Security Considerations, Next steps.

Research reports: keep concise (≤150 lines), cover all requested topics with citations.
