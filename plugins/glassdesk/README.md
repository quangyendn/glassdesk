...
- **Project Wiki Maintainer (v0.3.0+)** — `/wiki`, `/wiki:init`, `/wiki:update`, `/wiki:lint`, `/ask:wiki`; committed `.gd-wiki/` Obsidian vault, QMD-indexed, ~10× cheaper queries vs codebase grep
