...
3. **Write** — Load 'references/learn-output.md'. Always run `mkdir -p .gd-wiki/insights` first (no `/wiki:init` prerequisite); then write entry to `.gd-wiki/insights/{YYMMDD}-{slug}.md`
